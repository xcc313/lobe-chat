...
import { settingsSelectors, userGeneralSettingsSelectors, keyVaultsConfigSelectors } from '@/store/user/selectors';
...
const useOpenaiSTT = (config: STTConfig) => {
  ...
  return useOpenAISTT(sttLocale, {
    ...config,
    api: {
      OPENAI_PROXY_URL: openAI.baseURL,
...
const OpenaiLocalSTT = memo<{ mobile?: boolean }>(({ mobile }) => {
